...
const Modal = props => (
  <div className="modal fade" data-backdrop={props.closeOnClickOutside ? "inherit" : "static"} data-keyboard={props.closeOnClickOutside ? "true" : "false"} id={props.id} role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
